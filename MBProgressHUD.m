...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
    if([[AppController sharedInstance] topBar])
    {
        [[AppController sharedInstance] topBar].userInteractionEnabled = NO;
    }
...
+ (BOOL)hideHUDForView:(UIView *)view animated:(BOOL)animated {
    if([[AppController sharedInstance] topBar])
    {
        [[AppController sharedInstance] topBar].userInteractionEnabled = YES;
    }
